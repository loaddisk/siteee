...
description: Look ma, I found a fake charity!
date: 2021-11-21
---
...
> **[[PenPen]]'s note:** Evan rashly equivalated the *Interledger livenet* to Interledger. He did this for a noble reason, the livenet *is* often equivalated, but they are not the same. Interledger is a standard, the livenet is the implementation representing the standard. Evan also wanted me to mention that he thinks the standard is awesome, and he thinks the livenet is the right thing for the wrong reason. More power to the creators using it! 🦸‍♀️
