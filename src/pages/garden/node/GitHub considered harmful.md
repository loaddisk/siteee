...
state: sunset
description: | 
  Is GitHub *commit*ed to *pull*ing people in the wrong direction?
  *ba dum tis*
date: 2022-02-28
...
Vercel sees the ~ in sr.ht's url and freaks out. Cloudflare has the same story as netlify, but only github and gitlab
